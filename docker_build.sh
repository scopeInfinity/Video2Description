...
docker pull scopeinfinity/video2description:deploy
docker image build  --target v2d -t scopeinfinity/video2description:latest --cache-from scopeinfinity/video2description:latest .
